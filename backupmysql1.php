...
<body>
<form method="POST">
    <label>Mysql user name :</label> <input type = "text" id = "username" name = "username"> <br>
    <label>Password:</label> <input type = "password" id = "password" name = "password"> <br>
    <label>Database name :</label> <input type = "text" id = "dbname" name = "dbname"> <br>
    <input type = "submit">
</form>
</body>
</html>
